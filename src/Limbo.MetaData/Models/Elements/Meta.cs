...
public class Meta : Element {
    ...
    /// <param name="charset">The document's character encoding. If the attribute is present, its value must be an
    ...
    /// <param name="content">The content of the name-value pair.</param>
    public Meta(string? name = null, string? content = null, string? hid = null, string? id = null, string? charset = null, string? httpEquiv = null, string? property = null) {
        Name = name;
        Content = content;
        Hid = hid;
        Id = id;
