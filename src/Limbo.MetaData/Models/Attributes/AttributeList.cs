...
namespace Limbo.MetaData.Models.Attributes {
    ...
    /// </summary>
    public class AttributeList : IEnumerable<KeyValuePair<string, string>> {
        ...
        /// <summary>
        /// Returns an enumerator that iterates through the a <see cref="AttributeList"/>.
        /// </summary>
        /// <returns>A <see cref="Dictionary{TKey,TValue}.Enumerator"/> structure for the <see cref="AttributeList"/>.</returns>
